...
$ go get github.com/beyondan/gqlgen
```
...
```bash
$ go run github.com/beyondan/gqlgen init
```
...
And run `go run github.com/beyondan/gqlgen generate`.
...
```go
//go:generate go run github.com/beyondan/gqlgen
```
